<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateUser.aspx.cs" Inherits="WSATTest.CreateUser" %>
        ...
        <tr>
            <td class="style1">
                ...
                <span>
                    ...
                    style="margin-left: 40px; width:250px;" TextMode="Password" ValidationGroup="UserGroup" />
